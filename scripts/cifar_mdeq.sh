...
#SBATCH -a 1-4
#SBATCH -o slurm_logs/cifar_mdeq_new-%j-%a.log
...
mpiexecjl -np 4 julia --project=experiments/cifar experiments/cifar/cifar10_deq.jl $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_COUNT
