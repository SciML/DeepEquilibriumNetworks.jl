...
@noinline function DiffEqSensitivity.SteadyStateAdjointProblem(
    sol::EquilibriumSolution, sensealg::DeepEquilibriumAdjoint, g::Nothing, dg; save_idxs=nothing
)
...
function DiffEqBase._concrete_solve_adjoint(
    prob::SteadyStateProblem, alg, sensealg::DeepEquilibriumAdjoint, u0, p, args...; save_idxs=nothing, kwargs...
)
...
function DiffEqSensitivity._adjoint_sensitivities(
    sol, sensealg::DeepEquilibriumAdjoint, alg, g, dg=nothing; abstol=1e-6, reltol=1e-3, kwargs...
)
    return DiffEqSensitivity.SteadyStateAdjointProblem(sol, sensealg, g, dg; kwargs...)
end

function DiffEqSensitivity._adjoint_sensitivities(
    sol, sensealg::DeepEquilibriumAdjoint, alg; g=nothing, dg=nothing, abstol=1e-6, reltol=1e-3, kwargs...
)
    return DiffEqSensitivity.SteadyStateAdjointProblem(sol, sensealg, g, dg; kwargs...)
end
