using DeepEquilibriumNetworks, Lux, OrdinaryDiffEq
using Test
...
@testset "MultiScaleSkipDeepEquilibriumNetworkV2" begin test_multiscale_skip_deep_equilibrium_network_v2() end
